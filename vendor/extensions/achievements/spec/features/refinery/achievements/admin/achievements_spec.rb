    ...
    describe "Admin" do
      describe "achievements" do
        ...
        describe "achievements list" do
          before do
            FactoryGirl.create(:achievement, :title => "UniqueTitleOne")
            FactoryGirl.create(:achievement, :title => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:achievement, :title => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:achievement, :title => "A title") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:achievement, :title => "UniqueTitleOne") }
